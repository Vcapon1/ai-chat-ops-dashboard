...
<?php
/**
 * "Descartados" column component
 */
?>
<div class="bg-gray-800 rounded-lg p-4">
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-lg font-semibold text-red-400">Descartados</h2>
        <span id="descartados-count" class="px-2 py-1 bg-red-600/20 text-red-400 text-sm rounded-full">
            <?php echo count($leadsDescartados); ?>
        </span>
    </div>
    <div id="descartados-column" class="kanban-column space-y-4">
        <?php foreach ($leadsDescartados as $lead): ?>
